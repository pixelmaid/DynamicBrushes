...
class BrushGraphic {
    ...
    init(view:BrushGraphicsView, scene:BrushGraphicsScene, id:String, ox:Float, oy:Float, r: Float, x: Float, y:Float,
        ...
        let stylusTextBg = Shape(form: Rect(x:-100, y:-20, w:200, h:20), fill:Macaw.Color.red)
...
//        stylusUpIcon.place = Transform.move(dx:800,dy:500)
        ...
        let originTextBg = Shape(form: Rect(x:-100, y:-10, w:200, h:20), fill:Macaw.Color.red)
        ...
        let inputTextBg = Shape(form: Rect(x:-100, y:-20, w:200, h:20), fill:Macaw.Color.blue)
        ...
        let computedTextBg = Shape(form: Rect(x:-100, y:-30, w:200, h:20), fill:Macaw.Color.green)
