...
//  DynamicBrushes
//
//  Created by JENNIFER MARY JACOBS on 5/26/17.
...
@interface JotViewManager ()

@end


@implementation JotViewManager
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        if (!jotView) {
            jotView = [[JotView alloc] initWithFrame:self.bounds];
           /* jotView.delegate = self;
            [self insertSubview:jotView atIndex:0];
