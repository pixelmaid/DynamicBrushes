...
//  PaletteKnife
//
//  Created by JENNIFER MARY JACOBS on 4/20/17.
...
var kBrushOpacity = (1.0 / 3.0)
let kBrushPixelStep = 4
var kBrushScale = 1.0
...
class BitmapCanvasView: UIView {
    ...
    private func initGL() -> Bool {
        ...
        brushTexture = self.texture(fromName: "particle_hard.png")
    ...
    func setBrushDiameter(brushDiameter:Float){
    ...
    func renderLine(from _start: CGPoint, to _end: CGPoint) {
   ...
   /* // Handles the start of a touch
    ...
    func setBrushColor(red: CGFloat, green: CGFloat, blue: CGFloat, alpha:Float) {
        // Update the brush color
        kBrushOpacity = (Double)(MathUtil.expMap(value: alpha, exp: 3.9));
